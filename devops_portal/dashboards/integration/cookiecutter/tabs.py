...
class OutputTab(tabs.Tab):
    ...
    slug = "console_output"
    template_name = "integration/cookiecutter/tabs/_tab_output.html"
    preload = False
...
class WorkflowTab(tabs.Tab):
    name = _("Workflow")
    slug = "workflow"
    template_name = "integration/cookiecutter/tabs/_tab_workflow.html"
    preload = False
...
class ParamTab(tabs.Tab):
    name = _("Parameters")
    slug = "params"
    template_name = "integration/cookiecutter/tabs/_tab_param.html"
    preload = False
