...
HORIZON_CONFIG = {
    'user_home': 'model_manager.views.get_user_home',
    'ajax_queue_limit': 10,
    'auto_fade_alerts': {
        'delay': 3000,
        'fade_duration': 1500,
...
TEMPLATE_CONTEXT_PROCESSORS = (
    ...
    'model_manager.context_processors.openstack',
)
...
AUTHENTICATION_BACKENDS = ('model_manager_auth.backend.DevopsPortalBackend',)
AUTHENTICATION_URLS = ['model_manager_auth.urls']
...
import model_manager.settings.enabled
import model_manager.settings.local.enabled
from model_manager.utils import settings

INSTALLED_APPS = list(INSTALLED_APPS)  # Make sure it's mutable
settings.update_dashboards(
    [
        model_manager.settings.enabled,
        model_manager.settings.local.enabled,
    ],
    HORIZON_CONFIG,
    INSTALLED_APPS,
)
...
from model_manager import policy
